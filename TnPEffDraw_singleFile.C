...
// Other parameters
#ifdef MUIDTRG
TString etaTag("Tot_absetadep_pT1d4_1d9");
TString absetaTag("Tot_absetadep_pT1d4_1d9");
TString centTag("Tot_pTdep_abseta16_24");
const int nAbsEtaBins = 3;
TString ptTag[nAbsEtaBins] = { "Tot_pTdep_abseta00_08", "Tot_pTdep_abseta08_16",  "Tot_pTdep_abseta16_24" };
TString allTag("Tot_pTdep_abseta00_08");
...
const char* fDataName[nSyst] = {"./Output/Data/tnp_DATA_1-3_scenario_10.root",  "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbGausPlusPol1.root",  "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbcbPlusPol2.root", "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbcbPlusPol1_loose.root"};
const char* fMCName[nSyst] = {"./Output/Data/tnp_DATA_1-3_scenario_10.root",  "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbGausPlusPol1.root",  "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbcbPlusPol2.root", "./Output/Data_syst/tnp_DATA_1-3_scenario_10_cbcbPlusPol1_loose.root"};
#endif
...
cout << "point2" << endl;
	...
	for (int i = 0; i < nSyst; i++) {
		ComEta0[i] = plotEff_1bin(daEtaData0[i], 1, "abseta");
		ComEta1[i] = plotEff_1bin(daEtaData1[i], 1, "abseta");
	}
...
cout << "entered the for loop" << endl;
		effPtMC[k] = plotEff_1bin(daPtMC1Bin0[k], 0, "abseta");
		effPtData[k] = plotEff_1bin(daPtData1Bin0[k], 0, "abseta");
...
TH2F *plotEff2D(RooDataSet *a, TString b) {
	...
	RooRealVar *xAx = (RooRealVar*)set->find("abseta");
	RooRealVar *eff = (RooRealVar*)set->find("efficiency");
